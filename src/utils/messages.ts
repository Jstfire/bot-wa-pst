export const MAIN_MENU = `🎉 Selamat datang di *Pelayanan Statistik Terpadu (PST) Badan Pusat Statistik Kabupaten Buton Selatan* 🎉
...
export const ADMIN_END = `Jika Anda sudah selesai berkonsultasi, *silakan ketik "00" untuk mengakhiri chat dan kembali ke menu utama.* 🔁
